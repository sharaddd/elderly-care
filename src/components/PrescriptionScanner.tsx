...
const PrescriptionScanner = ({ open, onOpenChange, isPage = false }: PrescriptionScannerProps) => {
    ...
    return (
        <div className={`w-full h-full bg-black flex flex-col absolute inset-0 left-0 top-0 z-[60] duration-300 animate-in slide-in-from-bottom-full overflow-hidden`}>
